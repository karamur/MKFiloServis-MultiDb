...
";
    ...
    public static async Task InitializeAsync(ApplicationDbContext context, IConfiguration configuration)
    {
        ...
        // Rent a Car kara liste tablosunu eski/yarim migration uygulanmis tenant veritabanlarinda da güvenceye al
        await EnsureRentACarKaraListeTableAsync(context, dbProvider);
