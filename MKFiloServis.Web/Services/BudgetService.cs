...
public class BudgetService : IBudgetService
{
    ...
    public async Task<BudgetOdeme> OdemeYapAsync(int odemeId, OdemeYapRequest request)
    {
        ...
        if (request.OdemeTipi == MKFiloServis.Shared.Entities.BudgetOdemeTipi.CariMahsup)
        {
    ...
    private static bool ShouldCreateKrediKartiBorcu(BudgetOdeme odeme, MKFiloServis.Shared.Entities.BudgetOdemeTipi odemeTipi)
        => odemeTipi == MKFiloServis.Shared.Entities.BudgetOdemeTipi.KrediKarti && !IsKrediKartiKalemi(odeme.MasrafKalemi);
