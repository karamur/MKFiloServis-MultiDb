...
public class EvrakExpiryOzet
{
    ...
    public List<MKFiloServis.Shared.Entities.EvrakDosya> ExpiredList { get; set; } = new();
    public List<MKFiloServis.Shared.Entities.EvrakDosya> WarningList { get; set; } = new();
}
