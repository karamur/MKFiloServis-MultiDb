        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var kiralamalar = await (
            ...
            select new RentACarKiralamaSatiri
            {
                ...
                GercekBaslangicTarihi = kiralama.GercekBaslangicTarihi,
                TeslimYakitSeviyesi = kiralama.TeslimYakitSeviyesi,
                IadeYakitSeviyesi = kiralama.IadeYakitSeviyesi,
                TeslimHasarNotlari = kiralama.TeslimHasarNotlari,
                IadeHasarNotlari = kiralama.IadeHasarNotlari,
                TeslimAksesuarlar = kiralama.TeslimAksesuarlar,
                IadeAksesuarlar = kiralama.IadeAksesuarlar,
                TeslimNotlari = kiralama.TeslimNotlari,
                IadeNotlari = kiralama.IadeNotlari,
