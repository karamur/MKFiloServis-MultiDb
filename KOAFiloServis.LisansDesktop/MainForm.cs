...
/// <summary>
/// KOAFiloServis Lisans Aktivasyon Key Uretici + Takip Sistemi.
...
///
/// 🔥 LISANS MODEL (LicenseInfo ile BIREBIR AYNI — KOAFiloServis.Shared.Entities.LicenseInfo):
...
public class MainForm : Form
{
    ...
    public MainForm()
    {
        ...
        Text = "KOAFiloServis Lisans Uretim Araci";
        Width = 900;
        Height = 750;
    ...
    void Uret()
    {
        ...
        try
        {
            ...
            // MUST MATCH: KOAFiloServis.Shared.Entities.LicenseInfo
